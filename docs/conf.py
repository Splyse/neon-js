...
context = {
    ...
    'slug': 'splyse-neon-js-docs',
    'name': u'splyse-neon-js-docs',
    'rtd_language': u'en',
    'programming_language': u'words',
    'canonical_url': 'https://splyse-neon-js-docs.readthedocs.io/en/latest/',
    'analytics_code': 'None',
    ...
    'github_user': 'Splyse',
    'github_repo': 'neon-js',
    'github_version': 'readthedocs',
    'display_github': True,
    'bitbucket_user': 'None',
    'bitbucket_repo': 'None',
    'bitbucket_version': 'readthedocs',
    'display_bitbucket': False,
    'gitlab_user': 'None',
    'gitlab_repo': 'None',
    'gitlab_version': 'readthedocs',
